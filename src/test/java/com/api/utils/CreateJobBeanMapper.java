...
public class CreateJobBeanMapper {
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		CreateJobPayload payload = new CreateJobPayload(mstServiceLocationId , mstPlatformIdId, mstWarrantyStatusId,oemId, customer,
				customerAddress, product, problemsList);
