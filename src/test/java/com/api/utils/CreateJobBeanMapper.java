...
public class CreateJobBeanMapper {
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
		...
		int mstPlatformIdId = Integer.parseInt(bean.getMst_platform_id());
		...
		CreateJobPayload payload = new CreateJobPayload(mstServiceLocationId, mstPlatformIdId, mstWarrantyStatusId,
				oemId, customer, customerAddress, product, problemsList);
