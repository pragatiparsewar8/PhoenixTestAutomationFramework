...
public class CreateJobAPITest extends BaseTest {
	...
	public void setUp() {
		...
		CustomerAddress customerAddress = new CustomerAddress("D404", "Vsanat Galaxy", "Bangur bangur", "inorvit",
				"Mumbai", "413517", "India", "Maharashtra");
		CustomerProduct customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "190887367343284",
				"190887367343284", "190887367343284", getTimeWithDaysAgo(10), Product.NEXUS_2.getCode(),
